...
import com.kijlee.android.demo.entity.ChinaTown_.county_id
 ...
 * @Package:        com.kijlee.android.demo.ui.cityselect
 * @ClassName:      FgCountyList
 * @Author:     kij
 * @Description:  县列表
 * @Date:    2022/10/26 23:24
 * @Version:    1.0
 */
class FgCountyList: Fragment() {
        ...
        set(value) {
            ...
            if(value!=null){
                ...
                chinaQuery = chinaBox!!.query().equal(ChinaTown_.city_id,cityId)
                    .equal(ChinaTown_.county_id,field)
                    .equal(ChinaTown_.town_id,0)
                    .order(
